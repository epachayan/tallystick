...
850 scenarios · 34 adversarial classes · 18 adjudication baselines · 158 tests · 12 gate stages
...
make check                         # 12-stage correctness gate
...
docs/       research record, findings 01-13, recheck register
```
